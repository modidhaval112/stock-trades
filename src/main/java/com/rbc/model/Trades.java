...
public class Trades {
	...
	private String daysToNextNividend;
	...
	public Trades(String quarter, String stock, String date, String open, String high, String low, String close,
			String volume, String percentChangePrice, String percentChangeVolumeOverLastWk, String previousWeeksVolume,
			String nextWeeksOpen, String nextWeeksClose, String percentChangeNextWeeksPrice, String daysToNextNividend,
		...
		this.daysToNextNividend = daysToNextNividend;
	...
	public String getDaysToNextNividend() {
		return daysToNextNividend;
	}

	public void setDaysToNextNividend(String daysToNextNividend) {
		this.daysToNextNividend = daysToNextNividend;
	}
